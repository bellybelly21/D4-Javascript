...
src: '../img/propiedad-alquiler1.jpg',
...
src: '../img/propiedad-alquiler2.jpg',
...
src: '../img/propiedad-alquiler3.jpg',
...
src: '../img/propiedad-alquiler4.jpg',
...
src: '../img/propiedad-alquiler5.jpg',
...
src: '../img/propiedad-alquiler6.jpg',
...
function fichaPropiedades_venta(numPropiedades) {
    const divFicha = document.querySelector(".ficha-venta");
    
    let template = '';
    for (const propiedad of propiedades_venta.slice(0, numPropiedades)) {
        ...
        <div class="propiedad-template">
            ...
            <h5>$${propiedad.costo} USD</h5>
            <hr>
            <span class="propiedad-pets-smoke"><span style="color: ${smokeColor}"><i class="fa-solid fa-smoking"></i> ${propiedad.smoke ? 'Permitido fumar' : 'No se permite fumar'}</span>
...
function fichaPropiedades_alquiler(numPropiedades) {
    const divFicha = document.querySelector(".ficha-alquiler");
    
    let template = '';
    for (const propiedad of propiedades_alquiler.slice(0, numPropiedades)) {
        let smokeColor = propiedad.smoke ? 'green' : 'red';
        let petsColor = propiedad.pets ? 'green' : 'red';
...
fichaPropiedades_venta(3);
fichaPropiedades_alquiler(3);